...
baseline has 3,526 explicit singular names, 1,086 distinct effective singulars,
1,356 archetype files, 225 multipart continuations, and nine nested objects.
...
## Main-line consumer status

No integrated replacement runtime currently consumes this archetype display
contract. `main` therefore proves schema, catalog, lossless-core, provenance,
and isolated runtime-collection preservation without claiming in-game display
behavior or routing validation through Classic. Wrapper replacement build and
runtime integration remains bounded by
[`atrinik/atrinik#266`](https://github.com/atrinik/atrinik/issues/266),
[`#269`](https://github.com/atrinik/atrinik/issues/269), and
[`#270`](https://github.com/atrinik/atrinik/issues/270).
