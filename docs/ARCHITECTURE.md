...
checked light-source ledger records main-line semantic digests and the pinned
Classic art-direction decisions without copying Classic runtime evidence or
claiming replacement rendering; see [`LIGHT_SOURCE_AUDIT.md`](LIGHT_SOURCE_AUDIT.md).
A new
