...
REQUIRED_POLICY = (
    ...
    "The sole applicable pull request is canonical",
    "a `main` pull request uses a closing keyword",
    "a `1.x` pull request links without one, and the issue is closed manually after merge",
